...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "saved" | "settings">(
    "overview",
  );
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-64 flex-shrink-0 space-y-6">
          <div className="glass-card p-6 rounded-2xl text-center relative overflow-hidden">
            ...
            <p className="text-sm text-[var(--text-muted)] truncate mb-4">
              {user.email}
            </p>
          ...
          {activeTab === "overview" && (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <Link
                  href="/booth-finder"
                  className="glass-card p-5 rounded-2xl hover:border-saffron-500/50 transition-colors group"
                >
                  ...
                  <p className="text-xs text-[var(--text-muted)]">
                    Locate your polling station on the map.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-xs text-[var(--text-muted)]">
                    Get answers to election queries instantly.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="text-xs text-[var(--text-muted)]">
                    Apply for new voter ID or corrections.
                  </p>
                </Link>
              </div>
              ...
              <div className="glass-card p-6 rounded-2xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)]">
                    ...
                    <button className="text-xs font-medium text-saffron-500 hover:underline">
                      Update
                    </button>
                  </div>
          ...
          {activeTab === "saved" && (
            <div className="glass-card p-8 rounded-2xl text-center">
              ...
              <p className="text-[var(--text-secondary)] text-sm max-w-md mx-auto mb-6">
                You haven&apos;t bookmarked any candidates, constituencies, or
                ECI rules yet.
              </p>
              <Link
                href="/candidates"
                className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-saffron-500 to-saffron-600 text-white text-sm font-medium rounded-xl hover:shadow-lg hover:shadow-saffron-500/25 transition-all"
              >
                Explore Candidates
              </Link>
            </div>
              ...
              <div className="space-y-6 max-w-md">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-[var(--border-color)] bg-[var(--bg-card)] text-[var(--text-muted)] opacity-70"
                  />
                  <p className="text-[10px] text-[var(--text-muted)] mt-1">
                    Managed by Google Auth
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">
