...
function PartyBar({
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs font-bold text-[var(--text-primary)] w-12 text-right">
        {party}
      </span>
      <div className="flex-1 h-7 bg-[var(--bg-glass)] rounded-lg overflow-hidden border border-[var(--border-color)]">
        <div
          ...
          style={{
            width: `${pct}%`,
            background: color,
            minWidth: seats > 0 ? "30px" : "0",
          }}
        >
          <span className="text-[0.65rem] font-bold text-white drop-shadow">
            {seats}
          </span>
        </div>
      </div>
...
export default function HomePage() {
  ...
  const ctas = [
    {
      icon: "",
      title: t("nav.voterServices"),
      desc:
        language === "en"
          ? "Register to vote, correct details, check status, download voter ID, and more."
          : "वोट देने के लिए पंजीकरण करें, विवरण सुधारें, स्थिति जांचें, मतदाता पहचान पत्र डाउनलोड करें, और बहुत कुछ।",
      href: "/voter",
      color: "#0EA5E9",
    },
    {
      ...
      desc:
        language === "en"
          ? "Interactive India map with detailed data for all 28 states and 8 union territories."
          : "सभी 28 राज्यों और 8 केंद्र शासित प्रदेशों के विस्तृत डेटा के साथ इंटरैक्टिव भारत मानचित्र।",
      href: "/states",
      color: "#138808",
    },
    {
      ...
      desc:
        language === "en"
          ? "Historical results from 2009-2024 with swing analysis, party tallies, and turnout data."
          : "स्विंग विश्लेषण, पार्टी मिलान और मतदान डेटा के साथ 2009-2024 के ऐतिहासिक परिणाम।",
      href: "/results",
      color: "#8B5CF6",
    },
    {
      icon: "",
      title: t("nav.eciRules"),
      desc:
        language === "en"
          ? "Complete guide to Model Code of Conduct, campaign rules, EVM/VVPAT, and more."
          : "आदर्श आचार संहिता, अभियान नियम, ईवीएम/वीवीपीएटी, और बहुत कुछ के लिए संपूर्ण मार्गदर्शिका।",
      href: "/eci-rules",
      color: "#EC4899",
    },
    {
      ...
      desc:
        language === "en"
          ? "Ask VoteBuddy anything about Indian elections in English or Hindi. Powered by AI."
          : "वोटबडी से भारतीय चुनावों के बारे में अंग्रेजी या हिंदी में कुछ भी पूछें। एआई द्वारा संचालित।",
      href: "/ai-assistant",
      color: "#F59E0B",
    },
  ];
  ...
  const statsGrid = [
    {
      label: t("home.registeredVoters"),
      value: 97,
      suffix: language === "en" ? " Cr+" : " करोड़+",
      icon: "",
    },
    {
      label: t("home.pollingBooths"),
      value: 10,
      suffix: language === "en" ? ".5 L+" : ".5 लाख+",
      icon: "",
    },
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-12 pb-8 sm:pt-20 sm:pb-12">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
              <Link
                href="/booth-finder"
                className="btn-accent text-base px-8 py-3 rounded-xl flex items-center gap-2"
              >
                {t("nav.boothFinder")}
              </Link>
              <Link
                href="/voter"
                className="btn-ghost text-base px-8 py-3 rounded-xl flex items-center gap-2"
              >
          ...
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
              ...
              <p className="text-sm text-[var(--text-secondary)] mt-1">
                {language === "en"
                  ? "18th General Election - 543 Seats"
                  : "18वां आम चुनाव - 543 सीटें"}
              </p>
            </div>
            <Link
              href="/results"
              className="text-sm font-semibold text-saffron-500 hover:underline"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="p-4 rounded-xl border border-saffron-500/20 bg-saffron-500/5">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-extrabold text-saffron-500">
                  293
                </span>
              </div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-1">
                {t("home.majorityMark")}: 272
              </p>
            </div>
            <div className="p-4 rounded-xl border border-india-ashoka/20 bg-india-ashoka/5">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-bold text-india-ashoka">
                  I.N.D.I.A
                </span>
                <span className="text-2xl font-extrabold text-india-ashoka">
                  234
                </span>
              </div>
              <div className="h-2 bg-[var(--bg-glass)] rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-india-ashoka to-blue-400 rounded-full"
                  style={{ width: "43.1%" }}
                />
              </div>
              <p className="text-xs text-[var(--text-muted)] mt-1">
                {t("home.others")}: 16 {t("home.seats")}
              </p>
            </div>
          </div>
