...
const MOCK_NEWS: (NewsItem & {
...
})[] = [
  {
    ...
    summary:
      "The Election Commission of India has confirmed that the final phase of polling will take place on June 1st across 57 constituencies in 8 states and UTs.",
    summaryHi:
      "भारत निर्वाचन आयोग ने पुष्टि की है कि मतदान का अंतिम चरण 1 जून को 8 राज्यों और केंद्र शासित प्रदेशों के 57 निर्वाचन क्षेत्रों में होगा।",
  ...
  },
  {
    ...
    summary:
      "Phase 6 of the Lok Sabha elections saw a moderate voter turnout, with West Bengal recording the highest at 78%. Delhi recorded 54%.",
    summaryHi:
      "लोकसभा चुनाव के छठे चरण में मध्यम मतदान देखा गया, जिसमें पश्चिम बंगाल में सबसे अधिक 78% दर्ज किया गया। दिल्ली में 54% दर्ज किया गया।",
    source: "PTI News",
  ...
  },
  {
    ...
    summary:
      "A video circulating on social media claiming EVM tampering in Uttar Pradesh is from a mock poll conducted in 2019. ECI has filed an FIR.",
    summaryHi:
      "उत्तर प्रदेश में ईवीएम छेड़छाड़ का दावा करने वाला सोशल मीडिया पर प्रसारित एक वीडियो 2019 में आयोजित एक मॉक पोल का है। ईसीआई ने प्राथमिकी दर्ज की है।",
  ...
  },
  {
    ...
    summary:
      "Voters can now use the official ECI WhatsApp chatbot to download their digital voter slip and find booth locations.",
    summaryHi:
      "मतदाता अब अपनी डिजिटल वोटर स्लिप डाउनलोड करने और बूथ स्थानों को खोजने के लिए आधिकारिक ईसीआई व्हाट्सएप चैटबॉट का उपयोग कर सकते हैं।",
    source: "Voter Guide",
  ...
  },
  {
    ...
    summary:
      "Home voting facilities and special transport arrangements have been implemented for voters above 85 years of age in Punjab.",
    summaryHi:
      "पंजाब में 85 वर्ष से अधिक आयु के मतदाताओं के लिए होम वोटिंग की सुविधा और विशेष परिवहन व्यवस्था लागू की गई है।",
    ...
    <div className="page-enter mx-auto max-w-5xl px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="grid gap-6">
        {filteredNews.map((item) => (
          <article
            key={item.id}
            className="glass-card p-6 rounded-2xl flex flex-col md:flex-row gap-6 group hover:border-saffron-500/50 transition-colors"
          >
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-[var(--border-color)]">
                <div className="flex items-center gap-4 text-xs text-[var(--text-muted)]">
                  <span className="font-medium text-[var(--text-primary)]">
                    {t("news.source")}:{" "}
                    {language === "en" ? item.source : item.sourceHi}
                  </span>
