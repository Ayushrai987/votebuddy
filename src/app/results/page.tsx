            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="bg-[var(--bg-glass)]">
                  <th className="p-4 font-semibold text-[var(--text-secondary)]">
                    {t("results.party")}
                  </th>
                  <th className="p-4 font-semibold text-[var(--text-secondary)]">
                    {t("results.seatsWon")}
              ...
              <tbody>
                {data.map((row, index) => {
                  ...
                  return (
                    <tr
                      key={row.party}
                      className="border-b border-[var(--border-color)] hover:bg-[var(--bg-glass)] transition-colors"
                    >
                      <td className="p-4">
                        <div className="flex items-center gap-2">
                          <div
