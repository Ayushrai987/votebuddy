...
export const sampleCandidates: Candidate[] = [
  ...
  },
  {
    ...
    gender: "Female",
    age: 48,
    education: "BA (Unfinished)",
    criminalCases: 0,
    assets: "Rs.15.3 Cr",
    liabilities: "Rs.0.8 Cr",
    result: "Lost",
    votes: 342823,
    margin: -167196,
    electionYear: 2024,
