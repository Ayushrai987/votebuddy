...
export default function Header() {
  ...
  return (
    <header
      role="banner"
      className="sticky top-0 z-50 border-b border-[var(--border-color)] bg-[var(--bg-card)] backdrop-blur-xl"
    >
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-saffron-500 focus:text-white focus:rounded-lg"
      >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          >
            ...
            <div>
              ...
              <span className="text-[0.65rem] text-[var(--text-muted)] font-medium hidden sm:block">
                {language === "en"
                  ? "India Election Platform | चुनाव मंच"
                  : "भारत चुनाव मंच | India Election Platform"}
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <span
                className={language === "hi" ? "text-saffron-500" : ""}
                aria-hidden="true"
              >
                HI
              </span>
              ...
              <span
                className={language === "en" ? "text-saffron-500" : ""}
                aria-hidden="true"
              >
                EN
              </span>
            ...
            {user ? (
              <div className="hidden lg:flex items-center gap-3">
                <Link
                  href="/dashboard"
                  className="w-8 h-8 rounded-full overflow-hidden border border-[var(--border-color)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-saffron-500"
              ...
              {user ? (
                <div className="flex items-center justify-between px-4 py-2">
                  <Link
                    href="/dashboard"
                    onClick={closeMenu}
                    className="flex items-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-saffron-500 focus-visible:rounded-lg"
                  >
