      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex flex-col items-end gap-1">
          <span 
            ...
            aria-live="polite"
          >
            {status.pulse && <span className="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse" aria-hidden="true" />}
            {status.label}
          </span>
          {!election.isAnnounced && (
            <span className="text-[0.55rem] text-orange-500 font-bold uppercase tracking-tighter" aria-label="Schedule not yet announced">
