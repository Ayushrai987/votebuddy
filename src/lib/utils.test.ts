import { getElectionStatus, formatVoteCount, isValidEPIC, getNextElectionDate, getNextElection, sanitizeInput, debounce } from './utils';
...
describe('Utility Functions', () => {
  ...
  describe('formatVoteCount', () => {
    ...
    it('should throw error for negative numbers', () => {
      expect(() => formatVoteCount(-1)).toThrow('Vote count cannot be negative');
    });
  });
